...
A relational database is a collection of related tables that store data. SQL (structured query language) is the language used to store and manipulate data in relational databases.

- [ ] Why do tables need a `primary key`?

You need a unique identifier for each table entry so you can perform CRUD operations on it.
...
you need an intermediary table created with a JOIN with 2 foreign keys referencing the primary keys of each table.
